...
In this release, LogBase provides basic API for schema definition and data operations. In the next releases, advanced features that are in the pipeline include secondary indexes, query processing engine, and system recovery.

The executable package and getting started documents of LogBase can be found at [1].
